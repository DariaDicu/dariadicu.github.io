$.getJSON('https://localhost:8000/x0_p_joint_10_3_17.json', function (data) {
...
// Alpha dependencies.
$.getJSON('https://localhost:8000/different_alphas_inference.json', function (data) {
...
// Alpha dependencies.
$.getJSON('https://localhost:8000/acf_data.json', function (data) {
